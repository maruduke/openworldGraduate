...
#region LGS
        ...
        // controller 활성화 및 추가
        public void AddHLODController(HLODControllerBase controller, Camera cam)
        {
            controller.UpdateCull(cam);
            Register(controller);
        }

        // controller 제어 해제 
        public void RemoveHLODController(HLODControllerBase controller)
        {
